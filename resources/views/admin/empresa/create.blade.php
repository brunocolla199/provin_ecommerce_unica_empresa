...
<li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ route('empresa') }}">{{__('page_titles.enterprise.index')}}</a></li>
<li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page"> {{__('page_titles.enterprise.create')}}</li>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('tipo_pessoa') ? ' has-error' : '' }}">
                                    ...
                                    <select name="tipo_pessoa" class="form-control seleckpicker" id="tipo_pessoa" value="{{ old('tipo_pessoa') }}" required>
                                        <option value="J" @if (old('tipo_pessoa') == 'J') selected @endif>Jurídica</option>
                                        <option value="F" @if (old('tipo_pessoa') == 'F') selected @endif>Física</option>
                                    </select>
                            ...
                            <div class="col-md-6" id="divCNPJ">
                                <div class="form-group{{ $errors->has('cnpj') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="cnpj" name="cnpj" value="{{ old('cnpj') }}" class="form-control cnpj" required autofocus>
                            ...
                            <div class="col-md-6" id="divCPF" style="display: none">
                                <div class="form-group{{ $errors->has('cpf') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="cpf" name="cpf" value="{{ old('cpf') }}" class="form-control cpf"  autofocus>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('razao_social') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="razao_social" name="razao_social" value="{{ old('razao_social') }}" class="form-control" required autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('nome_fantasia') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="nome_fantasia" class="form-control" name="nome_fantasia" value="{{ old('nome_fantasia') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('cep') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="cep" name="cep" value="{{ old('cep') }}" class="form-control cep" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('endereco') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="endereco" name="endereco" value="{{ old('endereco') }}" class="form-control " required>
