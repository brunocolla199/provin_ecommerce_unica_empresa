                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('empresa_terceiro_id') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" type="number" min="1" max="1000" id="empresa_terceiro_id" name="empresa_terceiro_id" value="{{ $empresa->empresa_terceiro_id }}" class="form-control " required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('fator_multiplicador') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" type="number" min="1" max="1000" id="fator_multiplicador" name="fator_multiplicador" value="{{ $empresa->fator_multiplicador }}" class="form-control " required>
