                ...
                <hr class="m-t-0 m-b-10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="{{route('pedido.entrega-hoje')}}">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="{{route('pedido.entrega-atrasada')}}">
                                <div class="card border-left-danger shadow h-100 py-2">
                                    <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Entregas Atrasadas</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$pedidoAtrasado}}</div>
                                        </div>
                                        <div class="col-auto">
                                        <i class="fas fa-truck-loading fa-2x text-gray-300"></i>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="pull-right" style="float:right">
                            <a href="{{ route('pedido') }}" class="btn btn-inverse" style="border-color: black"> @lang('buttons.general.clear')</a>
                        </div>
                    </div>
