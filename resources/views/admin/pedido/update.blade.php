                            ...
                            <tbody>
                                ...
                                <tr class="">
                                        ...
                                        <td class="d-none d-md-table-cell">
                                                <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1 lazyload" data-src="@if (file_exists(public_path($caminho_imagem.'/'.$item->produto->produto_terceiro.'.jpeg'))) {{asset($caminho_imagem.'/'.$item->produto->produto_terceiro.'.jpeg')}} @else {{asset('ecommerce/assets/img/300X300/img1.jpg')}} @endif" src="{{asset('ecommerce/assets/img/300X300/img1.jpg')}}" alt="Image Description"></a>
                                        </td>
