...
@section('page_title', __('page_titles.ecommerce.carrinho'))
            ...
            <table class="table" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td class="d-none d-md-table-cell">
                            <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="{{asset('ecommerce/assets/img/300X300/img7.png')}}" alt="Image Description"></a>
                        </td>
