                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                    <!-- Logo -->
                                    <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="{{route('ecommerce.produto')}}" aria-label="Electro">
                                            <!--
                                    ...
                                    <div class="d-flex">
                                        <ul class="d-flex list-unstyled mb-0">
                                            ...
                                            <li class="col pr-0 mr-3">
                                                <a href="@if (!empty($pedidoNormal[0])){{route('ecommerce.carrinho.detalhe', ['id' => $pedidoNormal[0]->id]) }} @else #  @endif" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Sacola">
                                                    ...
                                                    @if (!empty($pedidoNormal[0]))
                                                        ...
                                                        <!--<span class="font-weight-bold font-size-16 text-gray-90 ml-3">R$ {{number_format($pedidoNormal[0]->total_pedido, 2, ',', '.') ?? ''}}</span>-->  
                                                    @endif
                                                </a>
                                            </li>
                                            @if (!Auth::check())
                                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                                ...
                                                <a  href="{{route('ecommerce.login-cadastro')}}"  role="button" class="u-header-topbar__nav-link_ pg-primary"
                                                    >
                                                    <img class="provin-icons" src="{{asset('img/icones/User.png')}}"></img> Cadastre-se <span class="text-gray-50">ou</span> Login
                                                </a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="position-relative">
                                                        <a id="languageDropdownInvoker" class="dropdown-nav-link dropdown-toggle d-flex align-items-center u-header-topbar__nav-link font-weight-normal" href="javascript:;" role="button"
                                                            ...
                                                            <span class="d-none d-sm-inline-flex align-items-center"><img class="provin-icons" src="{{asset('img/icones/User.png')}}"></img> {{Auth::user()->name}}</span>
                                                        </a>
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3">
                                            <a href="@if (!empty($pedidoNormal[0])){{route('ecommerce.carrinho.detalhe', ['id' => $pedidoNormal[0]->id]) }} @else #  @endif" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Sacola">
                                                ...
                                                @if (!empty($pedidoNormal[0]))
                                                    ...
                                                    <!--<span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">R$ {{number_format($pedidoNormal[0]->total_pedido, 2, ',', '.') ?? ''}}</span>-->    
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="position-relative">
                                                        <a id="languageDropdownInvoker" class="dropdown-nav-link dropdown-toggle d-flex align-items-center u-header-topbar__nav-link font-weight-normal" href="javascript:;" role="button"
                                                            ...
                                                            data-unfold-animation-out="fadeOut">
                                                            <span class="d-inline-block d-sm-none"></span>
                                                            <span class="d-sm-inline-flex align-items-center"><img class="provin-icons" src="{{asset('img/icones/User.png')}}"></img> {{Auth::user()->name}}</span>
                                                        </a>
        
                                                        <div id="languageDropdown2" style="margin-left:-10px" class="dropdown-menu dropdown-unfold" aria-labelledby="languageDropdownInvoker">
                                                            <form id="logout-form" style="margin-left:-10px" action="{{ route('logout') }}" method="POST" >
                                                                @csrf
                                                                <button type="submit" class="dropdown-item active" style="font-size: 14px"><i class="fas fa-sign-out-alt"></i> Sair</button>
                    ...
                    <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                        ...
                        <div class="js-scrollbar u-sidebar__body">
                            <div class="u-sidebar__content u-header-sidebar__content">
                                <form class="js-validate" method="POST" action="{{ route('login') }}"  class="js-validate" novalidate="novalidate">
                                        @csrf
                                    <!-- Login -->
                                    <div id="login" data-target-group="idForm">
                                        <!-- Title -->
                                        <header class="text-center mb-7">
                                        <h2 class="h4 mb-0">Bem Vindo!</h2>
                                        ...
                                        <!-- End Title -->
                                                ...
                                                <div class="d-flex justify-content-end mb-4">
                                                    ...
                                                    data-animation-in="slideInUp">Esqueceu a Senha?</a>
                                                </div>
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <a class="js-animation-link small text-dark" href="javascript:;"
                                               data-target="#signup"
                                               data-link-group="idForm"
                                               data-animation-in="slideInUp">Cadastre-se
                                            </a>
                                        </div>
                                    <!--
                                    ...
                                    <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                        ...
                                        <div class="text-center mb-4">
                                            <span class="small text-muted">Já tenho uma conta?</span>
                                            <a class="js-animation-link small text-dark" href="javascript:;"
                                                data-target="#login"
                                                data-link-group="idForm"
                                    ...
                                    <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                        ...
                                        <header class="text-center mb-7">
                                            ...
                                            <p>Digite seu endereço de e-mail e um e-mail com instruções será enviado para você.</p>
                                        </header>
                                        <!-- End Title -->
